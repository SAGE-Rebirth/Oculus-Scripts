...
public class Draw : MonoBehaviour
{
    ...
    void DrawRight(Transform drawingPoint)
    {
        ...
        {
            if(Vector3.Distance(RightLineRenderer.GetPosition(indexR), drawingPoint.position) >= precission)
            {
                indexR++;
    ...
    void DrawLeft(Transform drawingPoint)
    {
        ...
        {
            if (Vector3.Distance(LeftLineRenderer.GetPosition(indexL), drawingPoint.position) >= precission)
            {
                indexL++;
